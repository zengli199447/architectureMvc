...
import com.nativeosproject.cn.mvcjobproject.BuildConfig;
...
import di.qualifier.MyUrl;
import model.http.api.MyApis;
import model.manager.RetrofitUrlManager;
...
//         添加公共参数拦截器
        HttpCommonInterceptor commonInterceptor = new HttpCommonInterceptor.Builder()
                .addHeaderParams("session_id", Constants.SESSION_ID)
                .build();
