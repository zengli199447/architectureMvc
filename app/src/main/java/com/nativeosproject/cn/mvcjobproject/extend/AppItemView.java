package com.nativeosproject.cn.mvcjobproject.extend;
...
public class AppItemView {
	...
	public View getAdapterView(final Context context, final AdInfo adInfo, int itemWidth, int itemHeight) {
		...
		GradientDrawable click_bg_grad = new GradientDrawable(Orientation.TOP_BOTTOM, new int[] { Color.parseColor("#FFD700"),
				Color.parseColor("#FFB90F"), Color.parseColor("#FFD700") });
		...
		try {
			...
			RelativeLayout.LayoutParams down_img_params = new RelativeLayout.LayoutParams(LayoutParams.WRAP_CONTENT,
					LayoutParams.WRAP_CONTENT);
			...
			// 颜色渐变
			GradientDrawable grad = new GradientDrawable(Orientation.LEFT_RIGHT, new int[] { Color.parseColor("#cccccc"),
					Color.parseColor("#ffffff"), Color.parseColor("#cccccc") });
