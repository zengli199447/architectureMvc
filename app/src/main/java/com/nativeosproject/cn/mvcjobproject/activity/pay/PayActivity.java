...
import sdktools.partylogin.AuthResult;
import sdktools.partylogin.OrderInfoUtil2_0;
import sdktools.partylogin.PayResult;
...
public class PayActivity extends BaseActivity implements View.OnClickListener {
    ...
    public void authV2(View v) {
        if (TextUtils.isEmpty(DataClass.PID) || TextUtils.isEmpty(DataClass.APPID)
                || (TextUtils.isEmpty(DataClass.RSA2_PRIVATE) && TextUtils.isEmpty(DataClass.RSA_PRIVATE))
                || TextUtils.isEmpty(DataClass.TARGET_ID)) {
         ...
         */
        boolean rsa2 = (DataClass.RSA2_PRIVATE.length() > 0);
        Map<String, String> authInfoMap = OrderInfoUtil2_0.buildAuthInfoMap(DataClass.PID, DataClass.APPID, DataClass.TARGET_ID, rsa2);
        ...
        Runnable authRunnable = new Runnable() {
            ...
            public void run() {
                ...
                Message msg = new Message();
                msg.what = DataClass.SDK_AUTH_FLAG;
                msg.obj = result;
                mHandler.sendMessage(msg);
            }
        };
